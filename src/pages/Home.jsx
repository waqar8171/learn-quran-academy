        ...
        <div className="carousel-inner">
          <div className="carousel-item active">
            ...
            <div className="carousel-caption">
              <h5>Welcome to IqraHub Quran Academy</h5>

              <p>
                We offer live online Quran classes for kids and adults across
                the USA. Learn Quran with Tajweed from experienced male and
                female teachers, all from the comfort of your home.
              </p>
            </div>
          </div>
          ...
          <div className="carousel-item">
            ...
            />
            <div className="carousel-caption">
              <h5>Online Quran Classes in the USA</h5>

              <p>
                Join our online Quran learning programs designed for children
                and adults. Study the Holy Quran with qualified teachers through
                flexible one-on-one live sessions.
              </p>
            </div>
          </div>
          ...
          <div className="carousel-item">
            ...
            />
            <div className="carousel-caption">
              <h5>Learn Quran Online with Expert Teachers</h5>

              <p>
                IqraHub Quran Academy provides professional online Quran classes
                for students in the USA. Enjoy personalized lessons, flexible
                schedules, and certified Quran tutors.
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="container">
          <div className="row align-items-stretch">
            ...
            <div className="col-lg-4 mb-4 fade-in">
              <div className="info-card h-100 d-flex flex-column">
                ...
                <div className="info-card-body text-center">
                  ...
                  />
                  <p>
                    Welcome to <span>IqraHub Quran Academy</span>. We provide
                    live online Quran classes for kids and adults throughout the
                    USA.
                  </p>

                  <p>
                    Learn Quran with proper Tajweed under the guidance of
                    qualified teachers. Our flexible online classes make Quran
                    learning easy and accessible from home.
                  </p>
                </div>
            ...
            <div className="col-lg-8 mb-4 fade-in">
              <div className="right-content h-100 d-flex flex-column">
                <h2 className="main-heading">ONLINE QURAN CLASSES IN USA</h2>
          ...
          <div className="content-section fade-in">
            <h2 className="content-title">
              Online Quran Classes in USA – Learn Quran Academy For Kids Online
            </h2>
