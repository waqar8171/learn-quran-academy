  ...
  return (
    <footer className="footer-dark text-light pt-5">
      <div className="container">
        <div className="row gy-4">
          ...
          <div className="col-lg-3 col-md-6">
            ...
            />
            <h5 className="fw-bold">Online Quran Classes in USA</h5>
          ...
          <div className="col-lg-3 col-md-6">
            ...
            <ul className="list-unstyled small mt-3">
              <li className="mb-2 footer-li">
                <NavLink to="/kidsQuran">Online Quran Classes for Kids</NavLink>
              </li>
              <li className="mb-2 footer-li">
                <NavLink to="/courses/quranReading">
                  Learn Quran Reading
                </NavLink>
              </li>
              <li className="mb-2 footer-li">
              ...
              <li className="mb-2 footer-li">
                <NavLink to="/courses/noorani">Learn Madni Qaida</NavLink>
              </li>
            </ul>
          </div>
      ...
      <div className="text-center border-top border-light border-opacity-25 mt-4 py-3 small">
        © 2026 Quran Learning USA. All Rights Reserved.
      </div>
    </footer>
  );
};
